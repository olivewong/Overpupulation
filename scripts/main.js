...
function initializeDogs() {
	dogs[0]  = new Dog("cooper", "Meet Cooper! Cooper is a four year-old female pitbull. She was purchased from a pet store as a puppy, but was left behind in the city when her owners moved. She has been a shelter resident for the past six months and is looking for a new home. Cooper loves chew toys, playing fetch, and taking naps in the sun. She’s a loveable and loyal dog that also wants to be loved by a new family. Try to get adopted!", ["Unfortunately, Olivia decides not to adopt Cooper. Although Cooper is energetic, Olivia wants a younger dog, so she will go probably to go a pet store. This leaves many perfectly trainable and loveable dogs like Cooper stuck in shelters.", "Sadly, Vanessa decides not to adopt Cooper. She doesn’t like that Cooper is a pitbull, and wants to look for a different breed, probably purebred. Like many potential adopters, Vanessa has misconceptions about pitbulls in general, even though many of them don’t have behavioral problems.", "Unfortunately, Heidi decides not to adopt Cooper. She is scared that Cooper will have behavioral problems after being abandoned by her previous owners, and doesn’t want to deal with re-training an adopted dog. In reality, her belief in the saying “old dogs can’t learn new tricks” is totally unfounded. Dogs never stop learning, and even if Logan were to purchase a puppy, she would still have to train that puppy.", "Daniel decides not to adopt Cooper because he doesn’t know Cooper’s history, and doesn’t want to take a chance on a sheltered animal. Most of the time, however, pets are left behind because their owners can’t afford to take care of them anymore, not necessarily because of behavioral issues. All Cooper really needs is some love and care, and a new home!", "Daniel decides to adopt Cooper. Cooper seems like he loves being with people, and would be a loyal companion. Cooper also looks like a dog that would be compatible with his dogs at home. Congratulations!"], dogChances[0], criticIndex);
